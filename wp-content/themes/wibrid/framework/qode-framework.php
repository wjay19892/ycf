...
function qode_theme_menu() {
	...
	init_qode_theme_options();
      ...
      'YMB.ME主题选项',                   // The value used to populate the browser's title bar when the menu page is active
      'YMB.ME主题选项',                   // The text of the menu in the administrator's sidebar
