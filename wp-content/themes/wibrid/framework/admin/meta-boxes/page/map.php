...
$qodeGeneral = new QodeMetaBox("page", "Qode 常规");
...
$qodeLeftMenuArea = new QodeMetaBox("page", "Qode 左菜单区域","vertical_area",array("no"));
...
$qodeHeader = new QodeMetaBox("page", "Qode 页眉","vertical_area",array("yes"));
...
$qodeTitle = new QodeMetaBox("page", "Qode 标题");
$qodeFramework->qodeMetaBoxes->addMetaBox("page_title",$qodeTitle);

	$qode_show_page_title = new QodeMetaField("select","qode_show-page-title","","不显示标题区域","启用这个选项将关闭标题区域", array(
			"" => "默认",
			"no" => "否",
			"yes" => "是"),
	...
	$qode_show_page_title_image = new QodeMetaField("yesempty","qode_show-page-title-image","","不再显示背景图像","启用此选项隐藏标题区域背景图像", array(), array("dependence" => true, "dependence_hide_on_yes" => "#qodef_qode_background_image_container", "dependence_show_on_yes" => "#qodef_qode_title-height"));
...
$qodeTitleAnimations = new QodeMetaBox('page', 'Qode 滚动标题动画', 'qode_show-page-title', array('yes'));
...
$qodeContentBottom = new QodeMetaBox("page", "Qode 内容底部");
...
$qodeBlog = new QodeMetaBox("page", "Qode 博客");
$qodeFramework->qodeMetaBoxes->addMetaBox("page_blog",$qodeBlog);

	$qode_choose_blog_category = new QodeMetaField("selectblank","qode_choose-blog-category","","博客分类","选择要显示文章的分类 (留空显示全部)",$qode_blog_categories);
	...
	$qode_enable_page_comments = new QodeMetaField("yesempty","qode_enable-page-comments","","显示评论","启用这个选项将在你的页面显示评论");
	$qodeBlog->addChild("qode_enable-page-comments",$qode_enable_page_comments);


// Side Bar Area

$qodeSideBar = new QodeMetaBox("page", "Qode 侧边栏");
$qodeFramework->qodeMetaBoxes->addMetaBox("page_side_bar",$qodeSideBar);

	$qode_show_sidebar = new QodeMetaField("select","qode_show-sidebar","default","布局","选择侧边栏布局",array( "default" => "Default",
	   "1" => "侧边栏 1/3 右",
	   "2" => "侧边栏 1/4 右",
	   "3" => "侧边栏 1/3 左",
	   "4" => "侧边栏 1/4 左",
...
$qodeSeo = new QodeMetaBox("page", "Qode 搜索引擎优化");
