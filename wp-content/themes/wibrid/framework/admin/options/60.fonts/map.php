...
$fontsPage->addChild("panel1",$panel1);
	...
	$group1 = new QodeGroup("H1 样式","Define styles for H1 heading");
	$panel1->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$h1_fontsize = new QodeField("textsimple","h1_fontsize","","文字大小 (px)","This is some description");
			...
			$h1_texttransform = new QodeField("selectblanksimple","h1_texttransform","","文本变换","This is some description",$options_texttransform);
		...
		$group1->addChild("row2",$row2);
			...
			$h1_fontstyle = new QodeField("selectblanksimple","h1_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row2->addChild("h1_fontstyle",$h1_fontstyle);
			$h1_fontweight = new QodeField("selectblanksimple","h1_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row2->addChild("h1_fontweight",$h1_fontweight);
			$h1_letterspacing = new QodeField("textsimple","h1_letterspacing","","字母间距 (px)","This is some description");
			$row2->addChild("h1_letterspacing",$h1_letterspacing);
			
	$group2 = new QodeGroup("H2 样式","Define styles for H2 heading");
	$panel1->addChild("group2",$group2);
		...
		$group2->addChild("row1",$row1);
			...
			$h2_fontsize = new QodeField("textsimple","h2_fontsize","","文字大小 (px)","This is some description");
			...
			$h2_texttransform = new QodeField("selectblanksimple","h2_texttransform","","文本变换","This is some description",$options_texttransform);
		...
		$group2->addChild("row2",$row2);
			...
			$h2_fontstyle = new QodeField("selectblanksimple","h2_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row2->addChild("h2_fontstyle",$h2_fontstyle);
			$h2_fontweight = new QodeField("selectblanksimple","h2_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row2->addChild("h2_fontweight",$h2_fontweight);
			$h2_letterspacing = new QodeField("textsimple","h2_letterspacing","","字母间距 (px)","This is some description");
			$row2->addChild("h2_letterspacing",$h2_letterspacing);
			
	$group3 = new QodeGroup("H3 样式","Define styles for H3 heading");
	$panel1->addChild("group3",$group3);
		...
		$group3->addChild("row1",$row1);
			...
			$h3_fontsize = new QodeField("textsimple","h3_fontsize","","文字大小 (px)","This is some description");
			...
			$h3_texttransform = new QodeField("selectblanksimple","h3_texttransform","","文本变换","This is some description",$options_texttransform);
		...
		$group3->addChild("row2",$row2);
			...
			$h3_fontstyle = new QodeField("selectblanksimple","h3_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row2->addChild("h3_fontstyle",$h3_fontstyle);
			$h3_fontweight = new QodeField("selectblanksimple","h3_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row2->addChild("h3_fontweight",$h3_fontweight);
			$h3_letterspacing = new QodeField("textsimple","h3_letterspacing","","字母间距 (px)","This is some description");
			$row2->addChild("h3_letterspacing",$h3_letterspacing);
			
	$group4 = new QodeGroup("H4 样式","Define styles for H4 heading");
	$panel1->addChild("group4",$group4);
		...
		$group4->addChild("row1",$row1);
			...
			$h4_fontsize = new QodeField("textsimple","h4_fontsize","","文字大小 (px)","This is some description");
			...
			$h4_texttransform = new QodeField("selectblanksimple","h4_texttransform","","文本变换","This is some description",$options_texttransform);
		...
		$group4->addChild("row2",$row2);
			...
			$h4_fontstyle = new QodeField("selectblanksimple","h4_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row2->addChild("h4_fontstyle",$h4_fontstyle);
			$h4_fontweight = new QodeField("selectblanksimple","h4_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row2->addChild("h4_fontweight",$h4_fontweight);
			$h4_letterspacing = new QodeField("textsimple","h4_letterspacing","","字母间距 (px)","This is some description");
			$row2->addChild("h4_letterspacing",$h4_letterspacing);
			
	$group5 = new QodeGroup("H5 样式","Define styles for H5 heading");
	$panel1->addChild("group5",$group5);
		...
		$group5->addChild("row1",$row1);
			...
			$h5_fontsize = new QodeField("textsimple","h5_fontsize","","文字大小 (px)","This is some description");
			...
			$h5_texttransform = new QodeField("selectblanksimple","h5_texttransform","","文本变换","This is some description",$options_texttransform);
		...
		$group5->addChild("row2",$row2);
			...
			$h5_fontstyle = new QodeField("selectblanksimple","h5_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row2->addChild("h5_fontstyle",$h5_fontstyle);
			$h5_fontweight = new QodeField("selectblanksimple","h5_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row2->addChild("h5_fontweight",$h5_fontweight);
			$h5_letterspacing = new QodeField("textsimple","h5_letterspacing","","字母间距 (px)","This is some description");
			$row2->addChild("h5_letterspacing",$h5_letterspacing);
			
	$group6 = new QodeGroup("H6 样式","Define styles for H6 heading");
	$panel1->addChild("group6",$group6);
		...
		$group6->addChild("row1",$row1);
			...
			$h6_fontsize = new QodeField("textsimple","h6_fontsize","","文字大小 (px)","This is some description");
			...
			$h6_texttransform = new QodeField("selectblanksimple","h6_texttransform","","文本变换","This is some description",$options_texttransform);
		...
		$group6->addChild("row2",$row2);
			...
			$h6_fontstyle = new QodeField("selectblanksimple","h6_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row2->addChild("h6_fontstyle",$h6_fontstyle);
			$h6_fontweight = new QodeField("selectblanksimple","h6_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row2->addChild("h6_fontweight",$h6_fontweight);
			$h6_letterspacing = new QodeField("textsimple","h6_letterspacing","","字母间距 (px)","This is some description");
			$row2->addChild("h6_letterspacing",$h6_letterspacing);

// Text

$panel2 = new QodePanel("文本", "text_panel");
$fontsPage->addChild("panel2",$panel2);

	$group1 = new QodeGroup("段落","Define styles for paragraph text");
	$panel2->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$text_fontsize = new QodeField("textsimple","text_fontsize","","文字大小 (px)","This is some description");
		...
		$group1->addChild("row2",$row2);
			...
			$text_fontstyle = new QodeField("selectblanksimple","text_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row2->addChild("text_fontstyle",$text_fontstyle);
			$text_fontweight = new QodeField("selectblanksimple","text_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row2->addChild("text_fontweight",$text_fontweight);
			$text_margin = new QodeField("textsimple","text_margin","","顶部/底部外边距 (px)","This is some description");
			$row2->addChild("text_margin",$text_margin);

	$group2 = new QodeGroup("链接","Define styles for link text");
	$panel2->addChild("group2",$group2);
		...
		$row2 = new QodeRow(true);
		$group2->addChild("row2",$row2);
			$link_fontstyle = new QodeField("selectblanksimple","link_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row2->addChild("link_fontstyle",$link_fontstyle);
			$link_fontweight = new QodeField("selectblanksimple","link_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row2->addChild("link_fontweight",$link_fontweight);
			$link_fontdecoration = new QodeField("selectblanksimple","link_fontdecoration","","描述文字","This is some description",$options_fontdecoration);
			$row2->addChild("link_fontdecoration",$link_fontdecoration);

// Header & Menu

$panel7 = new QodePanel("页眉 & 菜单", "header_and_menu_panel");
$fontsPage->addChild("panel7",$panel7);

	$group1 = new QodeGroup("第1层菜单","Define styles for 1st level in Top Navigation Menu");
	$panel7->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$menu_activecolor = new QodeField("colorsimple","menu_activecolor","","激活文字颜色","This is some description");
		...
		$group1->addChild("row2",$row2);
			...
			$menu_fontsize = new QodeField("textsimple","menu_fontsize","","文字大小 (px)","This is some description");
		...
		$group1->addChild("row3",$row3);
			$menu_fontstyle = new QodeField("selectblanksimple","menu_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row3->addChild("menu_fontstyle",$menu_fontstyle);
			$menu_fontweight = new QodeField("selectblanksimple","menu_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row3->addChild("menu_fontweight",$menu_fontweight);
			$menu_letterspacing = new QodeField("textsimple","menu_letterspacing","","字母间距 (px)","This is some description");
			$row3->addChild("menu_letterspacing",$menu_letterspacing);
            $menu_text_transform = new QodeField("selectblanksimple","menu_text_transform","","文本变换","This is some description",$options_texttransform);
            $row3->addChild("menu_text_transform",$menu_text_transform);

        $row4 = new QodeRow(true);
        $group1->addChild("row4",$row4);
            $menu_separator_between_items = new QodeField("yesnosimple","menu_separator_between_items","no","2项之间显示分隔符","This is some description");
            $row4->addChild("menu_separator_between_items",$menu_separator_between_items);
            $menu_separator_color = new QodeField("colorsimple","menu_separator_color","","分隔符颜色","This is some description");
            $row4->addChild("menu_separator_color",$menu_separator_color);
            $menu_padding_left_right = new QodeField("textsimple","menu_padding_left_right","","内边距左/右 (px)","This is some description");
            $row4->addChild("menu_padding_left_right",$menu_padding_left_right);

	$group2 = new QodeGroup("第2层菜单","Define styles for 2nd level in Top Navigation Menu");
	$panel7->addChild("group2",$group2);
		...
		$group2->addChild("row1",$row1);
			...
			$dropdown_hovercolor = new QodeField("colorsimple","dropdown_hovercolor","","悬停/激活颜色","This is some description");
		...
		$group2->addChild("row2",$row2);
			...
			$dropdown_fontsize = new QodeField("textsimple","dropdown_fontsize","","文字大小 (px)","This is some description");
			...
			$dropdown_padding_top_bottom = new QodeField("textsimple","dropdown_padding_top_bottom","","内边距顶部/底部","This is some description");
			$row2->addChild("dropdown_padding_top_bottom",$dropdown_padding_top_bottom);
		$row3 = new QodeRow(true);
		$group2->addChild("row3",$row3);
			$dropdown_fontstyle = new QodeField("selectblanksimple","dropdown_fontstyle","","字体样式","This is some description",$options_fontstyle);
			$row3->addChild("dropdown_fontstyle",$dropdown_fontstyle);
			$dropdown_fontweight = new QodeField("selectblanksimple","dropdown_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row3->addChild("dropdown_fontweight",$dropdown_fontweight);
			$dropdown_letterspacing = new QodeField("textsimple","dropdown_letterspacing","","字母间距 (px)","This is some description");
			$row3->addChild("dropdown_letterspacing",$dropdown_letterspacing);
			$dropdown_texttransform = new QodeField("selectblanksimple","dropdown_texttransform","","文本变换","This is some description",$options_texttransform);
			$row3->addChild("dropdown_texttransform",$dropdown_texttransform);

	$group3 = new QodeGroup("第2层菜单拉满","Define styles for 2nd level in Wide Menu");
	$panel7->addChild("group3",$group3);
		...
		$group3->addChild("row2",$row2);
			...
			$dropdown_wide_fontsize = new QodeField("textsimple","dropdown_wide_fontsize","","文字大小 (px)","This is some description");
		...
		$group3->addChild("row3",$row3);
			$dropdown_wide_fontstyle = new QodeField("selectblanksimple","dropdown_wide_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row3->addChild("dropdown_wide_fontstyle",$dropdown_wide_fontstyle);
			$dropdown_wide_fontweight = new QodeField("selectblanksimple","dropdown_wide_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row3->addChild("dropdown_wide_fontweight",$dropdown_wide_fontweight);
			$dropdown_wide_letterspacing = new QodeField("textsimple","dropdown_wide_letterspacing","","字母间距 (px)","This is some description");
			$row3->addChild("dropdown_wide_letterspacing",$dropdown_wide_letterspacing);
			$dropdown_wide_texttransform = new QodeField("selectblanksimple","dropdown_wide_texttransform","","文本变换","This is some description",$options_texttransform);
			$row3->addChild("dropdown_wide_texttransform",$dropdown_wide_texttransform);

	$group4 = new QodeGroup("第3层菜单拉满","Define styles for 3rd level in wide menu");
	$panel7->addChild("group4",$group4);
		...
		$group4->addChild("row1",$row1);
			...
			$dropdown_hovercolor_thirdlvl = new QodeField("colorsimple","dropdown_hovercolor_thirdlvl","","悬停/激活颜色","This is some description");
		...
		$group4->addChild("row2",$row2);
			...
			$dropdown_fontsize_thirdlvl = new QodeField("textsimple","dropdown_fontsize_thirdlvl","","文字大小 (px)","This is some description");
		...
		$group4->addChild("row3",$row3);
			$dropdown_fontstyle_thirdlvl = new QodeField("selectblanksimple","dropdown_fontstyle_thirdlvl","","字体风格","This is some description",$options_fontstyle);
			$row3->addChild("dropdown_fontstyle_thirdlvl",$dropdown_fontstyle_thirdlvl);
			$dropdown_fontweight_thirdlvl = new QodeField("selectblanksimple","dropdown_fontweight_thirdlvl","","字体粗细","This is some description",$options_fontweight);
			$row3->addChild("dropdown_fontweight_thirdlvl",$dropdown_fontweight_thirdlvl);
			$dropdown_letterspacing_thirdlvl = new QodeField("textsimple","dropdown_letterspacing_thirdlvl","","字母间距 (px)","This is some description");
			$row3->addChild("dropdown_letterspacing",$dropdown_letterspacing_thirdlvl);
			$dropdown_texttransform_thirdlvl = new QodeField("selectblanksimple","dropdown_texttransform_thirdlvl","","文本变换","This is some description",$options_texttransform);
			$row3->addChild("dropdown_texttransform_thirdlvl",$dropdown_texttransform_thirdlvl);

	$group5 = new QodeGroup("固定菜单","Define styles for fixed menu");
	$panel7->addChild("group5",$group5);
		...
		$group5->addChild("row1",$row1);
			...
			$fixed_hovercolor = new QodeField("colorsimple","fixed_hovercolor","","悬停/激活颜色","This is some description");
		...
		$group5->addChild("row2",$row2);
			...
			$fixed_fontsize = new QodeField("textsimple","fixed_fontsize","","文字大小 (px)","This is some description");
		...
		$group5->addChild("row3",$row3);
			$fixed_fontstyle = new QodeField("selectblanksimple","fixed_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row3->addChild("fixed_fontstyle",$fixed_fontstyle);
			$fixed_fontweight = new QodeField("selectblanksimple","fixed_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row3->addChild("fixed_fontweight",$fixed_fontweight);
			$fixed_letterspacing = new QodeField("textsimple","fixed_letterspacing","","字母间距 (px)","This is some description");
			$row3->addChild("fixed_letterspacing",$fixed_letterspacing);
			$fixed_texttransform = new QodeField("selectblanksimple","fixed_texttransform","","文本转换","This is some description",$options_texttransform);
			$row3->addChild("fixed_texttransform",$fixed_texttransform);

	$group6 = new QodeGroup("置顶菜单","Define styles for sticky menu");
	$panel7->addChild("group6",$group6);
		...
		$group6->addChild("row1",$row1);
			...
			$sticky_hovercolor = new QodeField("colorsimple","sticky_hovercolor","","悬停/激活颜色","This is some description");
		...
		$group6->addChild("row2",$row2);
			...
			$sticky_fontsize = new QodeField("textsimple","sticky_fontsize","","文字大小 (px)","This is some description");
		...
		$group6->addChild("row3",$row3);
			...
			$sticky_fontweight = new QodeField("selectblanksimple","sticky_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row3->addChild("sticky_fontweight",$sticky_fontweight);
			$sticky_letterspacing = new QodeField("textsimple","sticky_letterspacing","","字母间距 (px)","This is some description");
			$row3->addChild("sticky_letterspacing",$sticky_letterspacing);
			$sticky_texttransform = new QodeField("selectblanksimple","sticky_texttransform","","文本转换","This is some description",$options_texttransform);
			$row3->addChild("sticky_texttransform",$sticky_texttransform);

	$group7 = new QodeGroup("手机菜单","Define styles for Mobile Menu (as seen on small screens)");
	$panel7->addChild("group7",$group7);
		...
		$group7->addChild("row1",$row1);
			...
			$mobile_hovercolor = new QodeField("colorsimple","mobile_hovercolor","","悬停/激活颜色","This is some description");
		...
		$group7->addChild("row2",$row2);
			...
			$mobile_fontsize = new QodeField("textsimple","mobile_fontsize","","文字大小 (px)","This is some description");
		...
		$group7->addChild("row3",$row3);
			$mobile_fontstyle = new QodeField("selectblanksimple","mobile_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row3->addChild("mobile_fontstyle",$mobile_fontstyle);
			$mobile_fontweight = new QodeField("selectblanksimple","mobile_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row3->addChild("mobile_fontweight",$mobile_fontweight);
			$mobile_letter_spacing = new QodeField("textsimple","mobile_letter_spacing","","字母间距 (px)","This is some description");
			$row3->addChild("mobile_letter_spacing",$mobile_letter_spacing);
			$mobile_texttransform = new QodeField("selectblanksimple","mobile_texttransform","","文本转换","This is some description",$options_texttransform);
			$row3->addChild("mobile_texttransform",$mobile_texttransform);

	$group8 = new QodeGroup("页眉顶部","Define styles for Header Top area");
	$panel7->addChild("group8",$group8);
		...
		$group8->addChild("row2",$row2);
			...
			$top_header_text_font_size = new QodeField("textsimple","top_header_text_font_size","","文字大小 (px)","This is some description");
		...
		$group8->addChild("row3",$row3);
			$top_header_text_font_style = new QodeField("selectblanksimple","top_header_text_font_style","","字体风格","This is some description",$options_fontstyle);
			$row3->addChild("top_header_text_font_style",$top_header_text_font_style);
			$top_header_text_font_weight = new QodeField("selectblanksimple","top_header_text_font_weight","","字体粗细","This is some description",$options_fontweight);
			$row3->addChild("top_header_text_font_weight",$top_header_text_font_weight);
			$top_header_text_letter_spacing = new QodeField("textsimple","top_header_text_letter_spacing","","字母间距 (px)","This is some description");
			$row3->addChild("top_header_text_letter_spacing",$top_header_text_letter_spacing);
			$top_header_text_texttransform = new QodeField("selectblanksimple","top_header_text_texttransform","","文本转换","This is some description",$options_texttransform);
...
$fontsPage->addChild("panel3",$panel3);
	...
	$group1 = new QodeGroup("小类型",'Define styles for default "Small" Title');
	$panel3->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$page_title_fontsize = new QodeField("textsimple","page_title_fontsize","","文字大小 (px)","This is some description");
		...
		$group1->addChild("row2",$row2);
			...
			$page_title_fontstyle = new QodeField("selectblanksimple","page_title_fontstyle","","字体风格","This is some description",$options_fontstyle);
			$row2->addChild("page_title_fontstyle",$page_title_fontstyle);
			$page_title_fontweight = new QodeField("selectblanksimple","page_title_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row2->addChild("page_title_fontweight",$page_title_fontweight);

	$group2 = new QodeGroup("中类型",'Define styles for default "Medium" Title');
	$panel3->addChild("group2",$group2);
		$row1 = new QodeRow();
		$group2->addChild("row1",$row1);
			$page_title_medium_fontsize = new QodeField("textsimple","page_title_medium_fontsize","","文字大小 (px)","This is some description");
			...
			$page_title_medium_fontweight = new QodeField("selectblanksimple","page_title_medium_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row1->addChild("page_title_medium_fontweight",$page_title_medium_fontweight);

	$group3 = new QodeGroup("大类型",'Define styles for default "Large" Title');
	$panel3->addChild("group3",$group3);
		$row1 = new QodeRow();
		$group3->addChild("row1",$row1);
			$page_title_large_fontsize = new QodeField("textsimple","page_title_large_fontsize","","文字大小 (px)","This is some description");
			...
			$page_title_large_fontweight = new QodeField("selectblanksimple","page_title_large_fontweight","","字体粗细","This is some description",$options_fontweight);
...
$fontsPage->addChild("panel4",$panel4);
	...
	$group1 = new QodeGroup("子标题","Define styles for page Subtitle");
	$panel4->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$page_subtitle_fontsize = new QodeField("textsimple","page_subtitle_fontsize","","文字大小 (px)","This is some description");
		...
		$group1->addChild("row2",$row2);
			...
			$page_subtitle_font_style = new QodeField("selectblanksimple","page_subtitle_font_style","","字体风格","This is some description",$options_fontstyle);
			$row2->addChild("page_subtitle_font_style",$page_subtitle_font_style);
			$page_subtitle_fontweight = new QodeField("selectblanksimple","page_subtitle_fontweight","","字体粗细","This is some description",$options_fontweight);
			$row2->addChild("page_subtitle_fontweight",$page_subtitle_fontweight);

	$group2 = new QodeGroup("大类型",'Define styles for default "Large" Subtitle');
	$panel4->addChild("group2",$group2);
		$row1 = new QodeRow();
		$group2->addChild("row1",$row1);
			$page_subtitle_large_fontsize = new QodeField("textsimple","page_subtitle_large_fontsize","","文字大小 (px)","This is some description");
			...
			$page_subtitle_large_fontweight = new QodeField("selectblanksimple","page_subtitle_large_fontweight","","字体粗细","This is some description",$options_fontweight);
...
$fontsPage->addChild("panel5",$panel5);
	...
	$group1 = new QodeGroup("页脚顶部标题类型",'Define styles for footer top title');
	$panel5->addChild("group1",$group1);
        ...
        $group1->addChild("row1",$row1);
            ...
            $footer_title_font_size = new QodeField("textsimple","footer_title_font_size","","文字大小 (px)","This is some description");
            $row1->addChild("footer_title_font_size",$footer_title_font_size);
            $footer_title_letter_spacing = new QodeField("textsimple","footer_title_letter_spacing","","字母间距 (px)","This is some description");
        ...
        $group1->addChild("row2",$row2);
            ...
            $footer_title_font_style = new QodeField("selectblanksimple","footer_title_font_style","","字体风格","This is some description",$options_fontstyle);
            $row2->addChild("footer_title_font_style",$footer_title_font_style);
            $footer_title_font_weight = new QodeField("selectblanksimple","footer_title_font_weight","","字体粗细","This is some description",$options_fontweight);
            $row2->addChild("footer_title_font_weight",$footer_title_font_weight);
            $footer_title_text_transform = new QodeField("selectblanksimple","footer_title_text_transform","","文本变换","This is some description",$options_texttransform);
            $row2->addChild("footer_title_text_transform",$footer_title_text_transform);

	$group2 = new QodeGroup("页脚顶部文字样式",'Define styles for footer top text');
	$panel5->addChild("group2",$group2);
        $row1 = new QodeRow();
        $group2->addChild("row1",$row1);
            $footer_text_font_size = new QodeField("textsimple","footer_text_font_size","","文字大小 (px)","This is some description");
            $row1->addChild("footer_text_font_size",$footer_text_font_size);
            $footer_text_letter_spacing = new QodeField("textsimple","footer_text_letter_spacing","","字母间距 (px)","This is some description");
        ...
        $row2 = new QodeRow(true);
        $group2->addChild("row2",$row2);
            $footer_text_font_style = new QodeField("selectblanksimple","footer_text_font_style","","文字风格","This is some description",$options_fontstyle);
            $row2->addChild("footer_text_font_style",$footer_text_font_style);
            $footer_text_font_weight = new QodeField("selectblanksimple","footer_text_font_weight","","文字重量","This is some description",$options_fontweight);
            $row2->addChild("footer_text_font_weight",$footer_text_font_weight);
            $footer_text_text_transform = new QodeField("selectblanksimple","footer_text_text_transform","","文本转换","This is some description",$options_texttransform);
            $row2->addChild("footer_text_text_transform",$footer_text_text_transform);

	$group3 = new QodeGroup("页脚顶部链接样式",'Define styles for footer top link');
	$panel5->addChild("group3",$group3);
        $row1 = new QodeRow();
        $group3->addChild("row1",$row1);
            $footer_link_font_size = new QodeField("textsimple","footer_link_font_size","","文字大小 (px)","This is some description");
            $row1->addChild("footer_link_font_size",$footer_link_font_size);
            $footer_link_letter_spacing = new QodeField("textsimple","footer_link_letter_spacing","","字母间距 (px)","This is some description");
        ...
        $row2 = new QodeRow(true);
        $group3->addChild("row2",$row2);
            $footer_link_font_style = new QodeField("selectblanksimple","footer_link_font_style","","文字风格","This is some description",$options_fontstyle);
            $row2->addChild("footer_link_font_style",$footer_link_font_style);
            $footer_link_font_weight = new QodeField("selectblanksimple","footer_link_font_weight","","文字重量","This is some description",$options_fontweight);
            $row2->addChild("footer_link_font_weight",$footer_link_font_weight);
            $footer_link_text_transform = new QodeField("selectblanksimple","footer_link_text_transform","","文本转换","This is some description",$options_texttransform);
            $row2->addChild("footer_link_text_transform",$footer_link_text_transform);

	$group4 = new QodeGroup("页脚底部文字样式",'Define styles for footer bottom text');
	$panel5->addChild("group4",$group4);
        $row1 = new QodeRow();
        $group4->addChild("row1",$row1);
            $footer_bottom_text_font_size = new QodeField("textsimple","footer_bottom_text_font_size","","文字大小 (px)","This is some description");
            $row1->addChild("footer_bottom_text_font_size",$footer_bottom_text_font_size);
            $footer_bottom_text_letter_spacing = new QodeField("textsimple","footer_bottom_text_letter_spacing","","字母间距 (px)","This is some description");
        ...
        $row2 = new QodeRow(true);
        $group4->addChild("row2",$row2);
            $footer_bottom_text_font_style = new QodeField("selectblanksimple","footer_bottom_text_font_style","","文字风格","This is some description",$options_fontstyle);
            $row2->addChild("footer_bottom_text_font_style",$footer_bottom_text_font_style);
            $footer_bottom_text_font_weight = new QodeField("selectblanksimple","footer_bottom_text_font_weight","","文字重量","This is some description",$options_fontweight);
            $row2->addChild("footer_bottom_text_font_weight",$footer_bottom_text_font_weight);
            $footer_bottom_text_text_transform = new QodeField("selectblanksimple","footer_bottom_text_text_transform","","文本转换","This is some description",$options_texttransform);
            $row2->addChild("footer_bottom_text_text_transform",$footer_bottom_text_text_transform);

	$group5 = new QodeGroup("页脚底部链接样式",'Define styles for footer bottom link');
	$panel5->addChild("group5",$group5);
        $row1 = new QodeRow();
        $group5->addChild("row1",$row1);
            $footer_bottom_link_font_size = new QodeField("textsimple","footer_bottom_link_font_size","","文字大小 (px)","This is some description");
            $row1->addChild("footer_bottom_link_font_size",$footer_bottom_link_font_size);
            $footer_bottom_link_letter_spacing = new QodeField("textsimple","footer_bottom_link_letter_spacing","","字母间距 (px)","This is some description");
        ...
        $row2 = new QodeRow(true);
        $group5->addChild("row2",$row2);
            $footer_bottom_link_font_style = new QodeField("selectblanksimple","footer_bottom_link_font_style","","文字风格","This is some description",$options_fontstyle);
            $row2->addChild("footer_bottom_link_font_style",$footer_bottom_link_font_style);
            $footer_bottom_link_font_weight = new QodeField("selectblanksimple","footer_bottom_link_font_weight","","文字重量","This is some description",$options_fontweight);
            $row2->addChild("footer_bottom_link_font_weight",$footer_bottom_link_font_weight);
            $footer_bottom_link_text_transform = new QodeField("selectblanksimple","footer_bottom_link_text_transform","","文本转换","This is some description",$options_texttransform);
            $row2->addChild("footer_bottom_link_text_transform",$footer_bottom_link_text_transform);

// Portfolio

$panel6 = new QodePanel("作品案例","portfolio_panel");
$fontsPage->addChild("panel6",$panel6);

	$group1 = new QodeGroup("分类筛选","Define styles for portfolio Category Filter");
	$panel6->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$portfolio_filter_hover_color = new QodeField("colorsimple","portfolio_filter_hover_color","","文字悬停/激活颜色","This is some description");
			$row1->addChild("portfolio_filter_hover_color",$portfolio_filter_hover_color);
			$portfolio_filter_font_size = new QodeField("textsimple","portfolio_filter_font_size","","文字大小 (px)","This is some description");
		...
		$row2 = new QodeRow(true);
		$group1->addChild("row2",$row2);
			$portfolio_filter_text_transform = new QodeField("selectblanksimple","portfolio_filter_text_transform","","文本转换","This is some description",$options_texttransform);
			...
			$portfolio_filter_font_style = new QodeField("selectblanksimple","portfolio_filter_font_style","","字体风格","This is some description",$options_fontstyle);
			$row2->addChild("portfolio_filter_font_style",$portfolio_filter_font_style);
			$portfolio_filter_font_weight = new QodeField("selectblanksimple","portfolio_filter_font_weight","","字体粗细","This is some description",$options_fontweight);
			$row2->addChild("portfolio_filter_font_weight",$portfolio_filter_font_weight);
		$row3 = new QodeRow(true);
		$group1->addChild("row3",$row3);
			$portfolio_filter_letter_spacing = new QodeField("textsimple","portfolio_filter_letter_spacing","","字母间距 (px)","This is some description");
