...
$maintenancePage->addChild("panel1",$panel1);
	...
	$maintenance_mode = new QodeField("yesno","qode_maintenance_mode","no","维护模式","Turn on this option if you want to enable maintenance mode on your site", array(),
    ...
    $maintenance_page = new QodeField("selectblank","qode_maintenance_page","",'维护页面','Choose maintenance page to display when user visits your site',$qode_pages);
